...
class WebArchive {
    ...
    async getCrawlInfoByYear(year, crawlMonths) {
        ...
        try {
            ...
            let monthDatas = Array.from(jsonData).filter(index => crawlMonths.includes(index));
